...
/* *INDENT-ON* */
    ...
    nourstest_true(strcmp(targets[1]._headers_checksum[0], "obj/include/unit.sha1") == 0);
    nourstest_true(strcmp(targets[1]._headers_checksum[1], "obj/include/types.sha1") == 0);
    nourstest_true(strcmp(targets[1]._headers_checksum[2], "obj/include/enums.sha1") == 0);
    nourstest_true(strcmp(targets[1]._headers_checksum[3], "obj/include/mounts_types.sha1") == 0);
    nourstest_true(strcmp(targets[1]._headers_checksum[4], "obj/include/mounts.sha1") == 0);
    nourstest_true(strcmp(targets[1]._headers_checksum[5], "obj/include/chapters.sha1") == 0);
    nourstest_true(strcmp(targets[1]._headers_checksum[6], "obj/include/shops.sha1") == 0);
    nourstest_true(strcmp(targets[1]._headers_checksum[7], "obj/include/options.sha1") == 0);
    nourstest_true(strcmp(targets[1]._headers_checksum[8], "obj/include/items.sha1") == 0);
    nourstest_true(strcmp(targets[1]._headers_checksum[9], "obj/include/units_stats.sha1") == 0);
    nourstest_true(strcmp(targets[1]._headers_checksum[10], "obj/include/skills_passive.sha1") == 0);
    nourstest_true(strcmp(targets[1]._headers_checksum[11], "obj/include/skills_active.sha1") == 0);
    nourstest_true(strcmp(targets[1]._headers_checksum[12], "obj/include/items_types.sha1") == 0);
    nourstest_true(strcmp(targets[1]._headers_checksum[13], "obj/include/items_stats.sha1") == 0);
    nourstest_true(strcmp(targets[1]._headers_checksum[14], "obj/include/weapon_stats.sha1") == 0);
    nourstest_true(strcmp(targets[1]._headers_checksum[15], "obj/include/units_PC.sha1") == 0);
    nourstest_true(strcmp(targets[1]._headers_checksum[16], "obj/include/units_NPC.sha1") == 0);
    nourstest_true(strcmp(targets[1]._headers_checksum[17], "obj/include/items_effects.sha1") == 0);
    nourstest_true(strcmp(targets[1]._headers_checksum[18], "obj/include/camp_jobs.sha1") == 0);
    nourstest_true(strcmp(targets[1]._headers_checksum[19], "obj/include/classes.sha1") == 0);
    nourstest_true(strcmp(targets[1]._headers_checksum[20], "obj/include/units_types.sha1") == 0);
    nourstest_true(strcmp(targets[1]._headers_checksum[21], "obj/include/armies.sha1") == 0);
    nourstest_true(strcmp(targets[1]._headers_checksum[22], "obj/include/units_statuses.sha1") == 0);
    nourstest_true(strcmp(targets[1]._headers_checksum[23], "obj/include/tiles.sha1") == 0);
    nourstest_true(strcmp(targets[1]._headers_checksum[24], "obj/include/game_states.sha1") == 0);
    nourstest_true(strcmp(targets[1]._headers_checksum[25], "obj/include/game_substates.sha1") == 0);
    nourstest_true(strcmp(targets[1]._headers_checksum[26], "obj/include/json_elements.sha1") == 0);
    nourstest_true(strcmp(targets[1]._headers_checksum[27], "obj/include/mvt_types.sha1") == 0);
    nourstest_true(strcmp(targets[1]._headers_checksum[28], "obj/include/buttons.sha1") == 0);
    ...
    nourstest_true(strcmp(targets[1]._headers_checksum[31], "obj/include/player_select.sha1") == 0);
    nourstest_true(strcmp(targets[1]._headers_checksum[32], "obj/include/errors.sha1") == 0);
    nourstest_true(strcmp(targets[1]._headers_checksum[33], "obj/include/input_flags.sha1") == 0);
    nourstest_true(strcmp(targets[1]._headers_checksum[34], "obj/include/scene_time.sha1") == 0);
    nourstest_true(strcmp(targets[1]._headers_checksum[35], "obj/include/structs.sha1") == 0);
    nourstest_true(strcmp(targets[1]._headers_checksum[36], "obj/include/nmath.sha1") == 0);
    nourstest_true(strcmp(targets[1]._headers_checksum[37], "obj/include/tnecs.sha1") == 0);
    nourstest_true(strcmp(targets[1]._headers_checksum[38], "obj/include/filesystem.sha1") == 0);
    nourstest_true(strcmp(targets[1]._headers_checksum[39], "obj/include/globals.sha1") == 0);
    nourstest_true(strcmp(targets[1]._headers_checksum[40], "obj/include/physfs.sha1") == 0);
    nourstest_true(strcmp(targets[1]._headers_checksum[41], "obj/include/platform.sha1") == 0);
    nourstest_true(strcmp(targets[1]._headers_checksum[42], "obj/include/cJSON.sha1") == 0);
    nourstest_true(strcmp(targets[1]._headers_checksum[43], "obj/include/nstr.sha1") == 0);
    nourstest_true(strcmp(targets[1]._headers_checksum[44], "obj/include/utilities.sha1") == 0);
    nourstest_true(strcmp(targets[1]._headers_checksum[45], "obj/include/palette.sha1") == 0);
    nourstest_true(strcmp(targets[1]._headers_checksum[46], "obj/include/debug.sha1") == 0);
    nourstest_true(strcmp(targets[1]._headers_checksum[47], "obj/include/macros.sha1") == 0);
    nourstest_true(strcmp(targets[1]._headers_checksum[48], "obj/include/names.sha1") == 0);
    nourstest_true(strcmp(targets[1]._headers_checksum[49], "obj/include/hashes.sha1") == 0);
    nourstest_true(strcmp(targets[1]._headers_checksum[50], "obj/include/supports.sha1") == 0);
    nourstest_true(strcmp(targets[1]._headers_checksum[51], "obj/include/support_types.sha1") == 0);
    nourstest_true(strcmp(targets[1]._headers_checksum[52], "obj/include/jsonio.sha1") == 0);
    nourstest_true(strcmp(targets[1]._headers_checksum[53], "obj/include/tile.sha1") == 0);
    nourstest_true(strcmp(targets[1]._headers_checksum[54], "obj/include/weapon.sha1") == 0);
    nourstest_true(strcmp(targets[1]._headers_checksum[55], "obj/include/item.sha1") == 0);
    nourstest_true(strcmp(targets[1]._headers_checksum[56], "obj/include/stb_sprintf.sha1") == 0);
    nourstest_true(strcmp(targets[1]._headers_checksum[57], "obj/include/pixelfonts.sha1") == 0);
    nourstest_true(strcmp(targets[1]._headers_checksum[58], "obj/include/convoy.sha1") == 0);
    nourstest_true(strcmp(targets[1]._headers_checksum[59], "obj/include/camp.sha1") == 0);
    nourstest_true(strcmp(targets[1]._headers_checksum[60], "obj/include/narrative.sha1") == 0);
    nourstest_true(strcmp(targets[1]._headers_checksum[61], "obj/include/bitfields.sha1") == 0);
    nourstest_true(strcmp(targets[1]._headers_checksum[62], "obj/include/RNG.sha1") == 0);
    nourstest_true(strcmp(targets[1]._headers_checksum[63], "obj/include/tinymt32.sha1") == 0);
    nourstest_true(strcmp(targets[1]._headers_checksum[64], "obj/include/sprite.sha1") == 0);
    nourstest_true(strcmp(targets[1]._headers_checksum[65], "obj/include/index_shader.sha1") == 0);
    nourstest_true(strcmp(targets[1]._headers_checksum[66], "obj/include/map.sha1") == 0);
    nourstest_true(strcmp(targets[1]._headers_checksum[67], "obj/include/arrow.sha1") == 0);
